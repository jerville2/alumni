...
@section('admin')
    ...
    <div class="container">
        {!! Form::open(['url' => '/admin/galleries/album/'.$album->id.'/upload/save', 'class' => 'form-horizontal', 'method' => 'post', 'files' => true, 'enctype' => 'multipart/form-data']) !!}
        {{ Form::token() }}
        ...
        <div align="center" class="form-group" style="padding: 20px">
            <a href="{!! url('admin/galleries/album/'.$album->id) !!}" class="btn-def">Cancel</a>
