...
@section('admin')
    <div class="container">
        ...
        {{ Form::open(['url'=> 'admin/opportunities/publish' , 'method' => 'post', 'files'=>'true', 'class'=>'form-horizontal','role'=>'form']) }}
        {{ Form::token() }}
        ...
        <div class="form-group{{ $errors->has('contents') ? ' has-error' : '' }}" style="margin: 5px">
            ...
            <textarea name="contents" id="ckeditor" class="ckeditor" cols="30" rows="25"></textarea>
